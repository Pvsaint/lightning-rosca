...
const LightningRoscaPage = () => {
  ...
  return (
    <main className="min-h-screen bg-orange-50 p-6">
      <section className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-6 space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <div className="flex items-center gap-3">
            <span className="text-3xl">{getCurrentRecipient()?.avatar}</span>
            <div>
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  {payment.paid ? (
                    ...
                    <button
                      onClick={() => createPayment(friend.id, currentRound - 1)}
                      className="bg-orange-500 text-white px-3 py-1 rounded hover:bg-orange-600"
                    >
                      Pay
                    </button>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {Array.from({ length: 4 }, (_, i) => (
            ...
            >
              <div className="text-center">
                <div className="text-lg font-bold">Round {i + 1}</div>
        ...
        <footer className="bg-gray-50 rounded-lg p-4">
          <h3 className="font-semibold mb-3">Personal Summary</h3>
